    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='meeting_room_app.MeetingRoom')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='order',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='meeting_room_app.User'),
        ),
        migrations.AlterUniqueTogether(
            name='order',
            unique_together=set([('room', 'period', 'schedule_date')]),
        ),
    ]
